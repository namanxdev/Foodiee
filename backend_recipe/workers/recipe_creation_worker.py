...
def _save_text_recipe(text_recipe: dict, supabase_url: str) -> int:
    ...
    NOTE: PostgreSQL automatically handles ID generation via auto-increment.
    IDs are NEVER reused, even if recipes are deleted. This ensures:
    - Data integrity (no ID collisions)
    - Proper audit trails in logs
    - Cache safety
    ...
    Returns:
        New recipe ID (auto-generated by PostgreSQL)
    """
